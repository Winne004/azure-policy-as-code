resource "azurerm_policy_set_definition" "Allowed_VM_sizes" {

  name                  = "Allowed_VM_sizes"
  policy_type           = "Custom"
  display_name          = "Test: Allowed VM Sizes"
  description           = "Contains policies controlling which VM SKUs can be used"
...
PARAMETERS
  ...
  dynamic "policy_definition_reference" {
    for_each = data.azurerm_policy_definition.builtin_policies_allowed_resources
    content {
